...
public class FragHowItWorks extends BaseFragment {
    ...
    private void setUi() {
      //  AppTools.showGifDialog(getActivity(), globalloader);
        ...
        //    Toast.makeText(mActivity, categoryId+"", Toast.LENGTH_SHORT).show();

        }
        tvHowitworks= rootView.findViewById(R.id.tvHowitworks);
    ...
    private class HorizontalCategoryAdapter extends RecyclerView.Adapter<HorizontalCategoryAdapter.WalletHolder> {
        ...
        public void onBindViewHolder
           ...
           /* holder.cv_View.setOnClickListener(new View.OnClickListener() {
            ...
            holder.ivImages.setText(String.valueOf(number));
            number=number+1;
