...
public class Profile_Repo {
    ...
    public class Data {
        ...
        @SerializedName("serve_alert_msg")
        @Expose
        private String serveAlertMsg;
        @SerializedName("serve_cities")
        @Expose
        private String serveCities;

        public String getServeAlertMsg() {
            return serveAlertMsg;
        }

        public void setServeAlertMsg(String serveAlertMsg) {
            this.serveAlertMsg = serveAlertMsg;
        }
        ...
        public void setServeCities(String serveCities) {
