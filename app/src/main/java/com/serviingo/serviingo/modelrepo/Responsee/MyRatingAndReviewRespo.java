...
public class MyRatingAndReviewRespo {
    ...
    public class Datum {
        ...
        public Object getRatingReviews() {
            return ratingReviews;
        }

        public void setRatingReviews(Object ratingReviews) {
