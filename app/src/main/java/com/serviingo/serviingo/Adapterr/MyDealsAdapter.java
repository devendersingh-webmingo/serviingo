...
public class MyDealsAdapter extends RecyclerView.Adapter<MyDealsAdapter.myViewHolder> {
    ...
    public MyDealsAdapter(subsubcategory_detailsRepo modelArrayList, Context context, AddToCartListener itemClickListenerr) {
        this.modelArrayList = modelArrayList;
        this.context = context;
        this.itemClickListenerr = itemClickListenerr;
    }

  /*  public MyPackageAdapter(subsubsubcategory_detailsRepo modelArrayList, Context context) {
        this.modelArrayList = modelArrayList;
        this.context = context;
    }*/
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyDealsAdapter.myViewHolder(view);
    }
...
*/
        ...
        if (modelArrayList.getData().getDeals().get(position).getGetRating().getRating()>0)
        {
            holder.text_rating.setRating(Float.parseFloat(String.valueOf(modelArrayList.getData().getDeals().get(position).getGetRating().getRating())));
    ...
    public interface AddToCartListener {
        ...
        void IncreaseQuentity(String Quentity, int position, subsubcategory_detailsRepo subsubcategory_detailsRepo);

        void DecressQuentity(String Quentity, int position, subsubcategory_detailsRepo subsubcategory_detailsRepo);
